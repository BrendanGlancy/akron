/**
 * @author Brendan Glancy Date: 03/27/22 Desc: Programming Challenge 10.7 and 10.8
 *     <p>10.7 Person and Customer classes Design a class named Person with fields for holding a
 *     person's name, address and telephone number. Write one or more constructors and the
 *     appropriate mutator and access methods for the class's fields.
 * @param getPersonName
 ...
 *     <p>Next, design a class named Customer, which extends Person. The Customer class should have
 *     a field for a customer number and a boolean field indicating whether the customer wishes to
 *     be on a mailing list. Write one or more constructors and the appropriate mutator and access
 *     methods for the class's fields. Demonstrate an object of the Customer class in a simple
 *     program
 ...
 *     <p>10.8 PreferredCustomer Class A retail store has a preferred customer plan where customers
 *     can earn discounts on all their purchases. The amount of a customer's discount is determined
 *     by the amount of the customers cumulative purchases in the store: When the customer spends
 *     $500, he or she get a 5 percent discount on all future purchases When the customer spends
 *     $1000, he or she get a 6 percent discount on all future purchases When the customer spends
 *     $1500, he or she get a 7 percent discount on all future purchases When the customer spends
 *     $2000, he or she get a 10 percent discount on all future purchases
 * @param getPurchases
 * @param setPurchases
 * @param getDiscountLevel
 *     <p>Design a class named PreferredCustomer, which extends the Customer class. The
 *     PreferredCustomer class should have fields for the amount of the customers purchases and the
 *     customers discount level. Write one or more constructors and the appropriate mutator and
 *     access methods for the class's fields. Demonstrate an object of the PreferredCustomer class
 *     in a simple program
 */
class Ch10Ex7Ex8GlancyBrendan {
  public static void main(String[] args) {
    ...
    PreferredCustomer preferredCustomer1 =
        new PreferredCustomer("Brendan Glancy", "456 Main St", "330-555-5555", 1, true, 1500);
...
class Customer extends Person {
  ...
  // Constructor
  public Customer(
      String name, String address, String phoneNumber, int number, boolean mailingList) {
